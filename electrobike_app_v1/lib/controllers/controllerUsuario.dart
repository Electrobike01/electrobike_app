...
class UserController {
  ...
  final String apiUrl =
      'https://electrobike-adso-wild.000webhostapp.com/apiRest/';
  ...
  Future<Map<String, dynamic>> Login(String email, String password) async {
    final response = await http.post(
      Uri.parse(
          'https://electrobike-adso-wild.000webhostapp.com/apiRest/login/login.php'
  ...
  Future<void> destroySession() async {
    await http.get(Uri.parse(
        'https://electrobike-adso-wild.000webhostapp.com/apiRest/login/destroy_session.php'
  ...
  Future<VerPerfilModel> getUserProfile(int idUsuario) async {
    final url =
        'https://electrobike-adso-wild.000webhostapp.com/apiRest/login/getDataUser.php?idUsuario=$idUsuario';
  ...
  Future<bool> validarDocumentoRepetido(
    ...
    final response = await http.get(Uri.parse(
        "https://electrobike-adso-wild.000webhostapp.com/apiRest/login/validarDocumento.php?idUsuario=$idUsuario&documentoUsuario=$documentoUsuario"
  ...
  Future<String> actualizarPerfil(UserProfileModel userProfile) async {
    try {
      ...
      'https://electrobike-adso-wild.000webhostapp.com/apiRest/login/actualizarUser.php';
  ...
  Future<bool> validarContrasena(
    ...
    final response = await http.get(Uri.parse(
        "https://electrobike-adso-wild.000webhostapp.com/apiRest/login/validarPassUser.php?idUsuario=$idUsuario&contrasenaUsuario=$contrasenaUsuario"

        // "http://192.168.0.4/apiElectrobike_app/login/validarPassUser.php?idUsuario=$idUsuario&contrasenaUsuario=$contrasenaUsuario"
        ));
    if (response.statusCode == 200) {// ======================== IMPORTACIONES ========================
import 'dart:convert';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
import '../models/UserProfileModel.dart';
...
class UserController {
  ...
  Future<String> actualizarContrasena(ModeloContrasena modeloContrasena) async {
    try {
      final actualizar_pass =
          'https://electrobike-adso-wild.000webhostapp.com/apiRest/login/actualizarPass.php';
          // 'http://192.168.0.4/apiElectrobike_app/login/actualizarPass.php';
      final response = await http.post(Uri.parse(actualizar_pass),
          body: modeloContrasena.toJsonUpdate());
