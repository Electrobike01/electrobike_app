...
class UserController {
  ...
  Future<Map<String, dynamic>> Login(String email, String password) async {
    final response = await http.post(
      Uri.parse(
          'https://electrobike-adso.000webhostapp.com/apiElectrobike_app/login/login.php'
  ...
  Future<void> destroySession() async {
    await http.get(Uri.parse(
        'https://electrobike-adso.000webhostapp.com/apiElectrobike_app/login/destroy_session.php'
  ...
  Future<VerPerfilModel> getUserProfile(int idUsuario) async {
    final url =
        'https://electrobike-adso.000webhostapp.com/apiElectrobike_app/login/getDataUser.php?idUsuario=$idUsuario';
  ...
  Future<bool> validarDocumentoRepetido(
    ...
    final response = await http.get(Uri.parse(
        "https://electrobike-adso.000webhostapp.com/apiElectrobike_app/login/validarDocumento.php?idUsuario=$idUsuario&documentoUsuario=$documentoUsuario"
  ...
  Future<String> actualizarPerfil(UserProfileModel userProfile) async {
    try {
      ...
      'https://electrobike-adso.000webhostapp.com/apiElectrobike_app/login/actualizarUser.php';
  ...
  Future<bool> validarContrasena(
    ...
    final response = await http.get(Uri.parse(
        "https://electrobike-adso.000webhostapp.com/apiElectrobike_app/login/validarPassUser.php?idUsuario=$idUsuario&contrasenaUsuario=$contrasenaUsuario"
  ...
  Future<String> actualizarContrasena(ModeloContrasena modeloContrasena) async {
    try {
      final actualizar_pass =
          'https://electrobike-adso.000webhostapp.com/apiElectrobike_app/login/actualizarPass.php';
